<template>
    <tool-page title="开发者工具">
        ...
        <h2 class="big-title">代码工具</h2>
        <ui-tool-list :data="codeTools"></ui-tool-list>

        <h2 class="big-title">前端工具</h2>
        <ui-tool-list :data="frontEndTools"></ui-tool-list>
