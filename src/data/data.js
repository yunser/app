...
let chemistryTools = [
    {
        href: 'https://chemistry.yunser.com/',
        icon: '/static/img/chemistry.svg',
        name: '元素周期表',
        description: '',
        tags: ['化学']
    }
...
let chineseTools = [
    {
        ...
        icon: '/static/img/pinyin.png',
        name: '拼音工具',
        description: '拼音标调、中文转拼音',
        tags: ['语文', '拼音']
    },
    {
        href: 'https://chinese.yunser.com/copybook',
        icon: '/static/img/copybook.png',
        name: '字帖生成',
        description: '',
        tags: ['语文']
    },
    {
        href: 'https://copybook.yunser.com/',
        icon: '/static/img/copybook.png',
        name: '字帖生成',
...
let studOtherTools = [
    {
        ...
        icon: '/static/img/black_board.svg',
        name: '黑板',
...
let devTools = [
    {
        ...
        icon: '/static/img/regex.png',
        name: '正则表达式测试',
        description: '匹配结果高亮显示',
        tags: ['开发']
    },
    {
        href: 'https://code.yunser.com/hex',
        icon: '/static/img/hex.png',
        name: '进制转换',
        description: '',
        tags: ['开发']
    },
    ...
    {
        href: 'https://code.yunser.com/timestamp',
        icon: '/static/img/timestamp.svg',
        name: '时间戳转换',
        description: 'Unix时间戳',
        tags: ['开发']
    },
...
let encodeTools = [
    ...
    {
        href: 'https://encrypt.yunser.com/encrypt',
...
let liveTools = [
    ...
    {
        href: 'https://weather.yunser.com/',
        icon: '/static/img/weather.svg',
        name: '天气',
        description: '',
        tags: ['生活']
    },
    ...
    },
    {
        ...
        icon: '/static/img/cloth.svg',
        name: '标准尺码对照表',
        description: '',
        tags: ['生活']
    },
    {
        href: 'https://calculator.yunser.com/',
        icon: '/static/img/calculator.svg',
        name: '计算器',
    ...
    },
    {
        ...
        icon: '/static/img/unit.jpg',
        name: '单位转换',
        description: '',
        tags: ['生活']
    },
    {
        href: 'https://counter.yunser.com',
    ...
    {
        href: 'https://note.yunser.com',
        icon: '/static/img/note.svg',
        name: '便签',
        description: '',
        tags: ['笔记', 'note', '生活']
    },
    {
        href: 'https://todo.yunser.com',
        icon: '/static/img/todo.jpg',
        name: '待办事项',
    ...
    },
    {
        ...
        icon: '/static/img/qiqiao.jpg',
        name: '七巧板',
        description: '',
        tags: ['生活']
    },
    {
        href: 'https://download.yunser.com/urlCoding',
    ...
    {
        href: 'https://password.yunser.com/tool/',
        icon: '/static/img/encrypt.svg',
        name: '随机密码生成',
...
let entTools = [
    {
        ...
        icon: '/static/img/tu.svg',
        name: '斗图神器',
        description: '表情包制作',
        tags: ['生活']
    },
    {
        href: 'https://bigger.yunser.com/drunbility/',
        icon: '/static/img/tu.svg',
        name: '装逼神器',
        description: '恶搞图片制作',
        tags: ['生活']
...
let timeTools = [
    {
        href: 'https://time.yunser.com/calendar',
        icon: '/static/img/calendar.svg',
        name: '日历',
        description: '万年历',
        tags: ['生活']
    },
    {
        ...
        icon: '/static/img/date_calculator.svg',
        name: '公历农历互转',
        description: '',
        tags: ['生活']
    },
    {
        href: 'https://time.yunser.com/',
        icon: '/static/img/timer.jpg',
        name: '秒表',
        description: '',
        tags: ['生活']
    },
    {
        href: 'https://time.yunser.com/countdown',
        icon: '/static/img/timer.jpg',
        name: '倒计时',
        description: '',
        tags: ['生活']
    ...
    {
        href: 'https://time.yunser.com/calculator/date',
        icon: '/static/img/date_calculator.svg',
        name: '日期计算器',
        description: '',
        tags: ['生活']
    ...
    },
    {
        ...
        icon: '/static/img/solarterms.png',
        name: '24节气',
        description: '',
        tags: ['生活']
    },
...
let healthTools = [
    {
        href: 'https://health.yunser.com/',
        icon: '/static/img/bmi.svg',
        name: 'BMI计算器',
...
let moneyTools = [
    {
        href: 'https://finance.yunser.com/',
        icon: '/static/img/loan.svg',
        name: '个人所得税计算器',
        description: '',
        tags: ['生活']
    },
    {
        href: 'https://finance.yunser.com/exchangeRate',
        icon: '/static/img/exchange_rate.svg',
        name: '汇率查询',
        description: '',
        tags: ['生活']
    },
...
let textTools = [
    ...
    {
        href: 'https://text.yunser.com/rich',
    ...
    {
        href: 'https://markdown.yunser.com/',
        icon: '/static/img/markdown.svg',
        name: 'Markdown 工具',
    ...
    {
        href: 'https://text.yunser.com/fullAndHalf',
    ...
    },
    {
        ...
        icon: '/static/img/file_build.svg',
        name: '文本处理',
    ...
    {
        href: 'https://text.yunser.com/letter',
    ...
    {
        href: 'https://text.yunser.com/chinese',
        icon: '/static/img/chinese.png',
        name: '简体繁体转换',
...
let imageTools = [
    ...
    {
        href: 'https://imagetool.yunser.com/',
        icon: '/static/img/image_tool.svg',
        name: '图片处理',
...
let queryTools = [
    {
        href: 'https://translation.yunser.com/',
        icon: '/static/img/translate.svg',
        name: '翻译',
        description: '仅支持英译汉',
        tags: ['生活']
    },
    {
        href: 'https://express.yunser.com/',
        icon: '/static/img/express.svg',
        name: '快递查询',
        description: '',
        tags: ['生活']
    },
    {
        href: 'https://phone.yunser.com/',
    ...
    {
        href: 'https://idcard.yunser.com/',
        icon: '/static/img/id_card.svg',
        name: '身份证查询',
        description: '身份证号码查询/验证',
        tags: ['生活']
    },
    {
        href: 'https://unicode.yunser.com/common',
        icon: '/static/img/fuhao.jpg',
        name: '特殊符号',
        description: '特殊符号大全',
        tags: ['生活']
    },
...
let makeTools = [
    ...
    {
        href: 'https://page.yunser.com',
        icon: '/static/img/display.svg',
        name: '演示',
        description: '',
        tags: ['办公']
    },
    ...
    {
        href: 'https://svg.yunser.com/',
        icon: '/static/img/shape.svg',
        name: '图形制作',
        description: '',
        tags: ['生活']
    },
    {
        href: 'https://chart.yunser.com/chart/',
        icon: '/static/img/bar_chart.svg',
        name: '图表制作',
        description: '',
        tags: ['生活']
    },
    ...
    },
    {
        ...
        icon: '/static/img/file_temp.svg',
        name: '临时网盘',
        description: '',
        tags: ['生活']
    },
    {
        href: 'https://converter.yunser.com/',
        icon: '/static/img/convert.svg',
        name: '格式转换',
        description: '',
        tags: ['生活']
    },
    {
        ...
        icon: '/static/img/topology.svg',
        name: '拓扑图制作',
        description: '',
        tags: ['生活']
    },
    {
        href: 'https://builder.yunser.com/',
        icon: '/static/img/component.png',
        name: '原型图制作',
...
let otherTools = [
    {
        href: 'https://download.yunser.com/',
        icon: '/static/img/download.svg',
        name: '图片批量下载',
        description: '图片批量下载器',
        tags: ['开发']
    ...
    {
        href: 'https://font.yunser.com',
        icon: '/static/img/font.svg',
        name: '字体生成',
        description: '',
        tags: ['生活']
    },
...
let mathTools = [
    {
        href: 'https://formula.yunser.com/',
        icon: '/static/img/formula.svg',
        name: '公式编辑器',
        description: '可视化公式编辑器'
    },
    {
        href: 'https://latex.yunser.com/',
        icon: '/static/img/formula.svg',
        name: 'LaTex 解析器',
        description: 'LaTex 生成图片'
    },
    {
        href: 'https://calculator.yunser.com/equation',
        icon: '/static/img/equation.svg',
        name: '方程求解',
        description: ''
    },
    {
    ...
    {
        href: 'https://math.yunser.com/prime2',
        icon: '/static/img/math.svg',
        name: '公约数公倍数',
        description: '最大公约数、公倍数'
    },
    {
        href: 'https://math.yunser.com/number/property',
        icon: '/static/img/math.svg',
        name: '数的性质',
        description: '数论、科学计数法、分解质因数等'
    },
    {
        href: 'https://math.yunser.com/statistics',
        icon: '/static/img/statistics.svg',
        name: '数学统计',
        description: ''
    },
    {
        href: 'https://math.yunser.com/compare',
        icon: '/static/img/math.svg',
        name: '数值大小比较',
        description: ''
    },
    ...
    {
        href: 'https://history.yunser.com/prime',
        icon: '/static/img/frame.png',
        name: '质数',
        description: '质数表'
    },
    {
        href: 'https://math.yunser.com/number',
        icon: '/static/img/number_split.svg',
        name: '数字的分解',
        description: ''
    }
]
...
let colorTools = [
    {
        href: 'https://color.yunser.com/colorScheme',
    ...
    {
        href: 'https://color.yunser.com/color/chinese',
        icon: '/static/img/color_cn.png',
        name: '中国传统色彩',
        description: '',
        tags: ['颜色', '开发']
    },
    {
        href: 'https://color.yunser.com/color/japen',
        icon: '/static/img/color_jp.png',
        name: '日本传统色彩',
        description: '',
        tags: ['颜色', '开发']
    },
    {
        href: 'https://color.yunser.com/gradient',
    ...
    {
        href: 'https://color.yunser.com/color/materialDesign',
        icon: '/static/img/color.svg',
...
let englishTools = [
    {
        href: 'https://english.yunser.com/',
        icon: '/static/img/letter.svg',
        name: '字母卡片',
        description: '',
        tags: []
    }
...
allTools = allTools.concat(chemistryTools)
...
allTools = allTools.concat(moneyTools)
allTools = allTools.concat(textTools)
allTools = allTools.concat(imageTools)
